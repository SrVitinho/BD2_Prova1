...
class MotoristaCLI(SimpleCLI):
    def __init__(self, motorista_model):
        ...
        self.add_command("create", self.crt_motorista)
        self.add_command("read", self.read_motorista)
        self.add_command("update", self.upd_motorista)
        self.add_command("delete", self.del_motorista)

    def crt_motorista(self):
        corridas = ()
        aux = 1
        while (aux == 1):
        ...
        self.motorista_model.crt_motorista(motorista)
    ...
    def upd_motorista(self):
        ...
        nota_motorista = int(input("Entre com a nota do motorista: "))
        motorista = Motorista(nota_motorista, corridas)
        self.motorista_model.upd_motorista(id, motorista)

    def del_motorista(self):
        id = input("Enter the id: ")
        self.motorista_model.del_motorista(id)
